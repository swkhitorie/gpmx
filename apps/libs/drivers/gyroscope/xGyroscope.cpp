...
xGyroscope::xGyroscope(uint32_t device_id, enum Rotation rotation) :
...
void xGyroscope::set_scale(float scale)
{
...
void xGyroscope::update(const hrt_abstime &timestamp_sample, float x, float y, float z)
{
...
void xGyroscope::updateFIFO(sensor_gyro_fifo_s &sample)
{
...
void xGyroscope::UpdateClipLimit()
{
