...
xAccelerometer::xAccelerometer(uint32_t device_id, enum Rotation rotation) :
...
void xAccelerometer::set_scale(float scale)
{
...
void xAccelerometer::update(const hrt_abstime &timestamp_sample, float x, float y, float z)
{
...
void xAccelerometer::updateFIFO(sensor_accel_fifo_s &sample)
{
...
void xAccelerometer::UpdateClipLimit()
{
