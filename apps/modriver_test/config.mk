PROJ_NAME  :=  module_driver_test
PROJ_TC    :=  gae
APP_PROJ_DIR = apps/modriver_test
...
CPPSOURCES += ${APP_PROJ_DIR}/sx126x_test.cpp

PROJ_CINCDIRS += apps/src/drivers/sx126x/
CSOURCES += apps/src/drivers/sx126x/sx126x_driver.c
CSOURCES += apps/src/drivers/sx126x/sx126x_hal.c
