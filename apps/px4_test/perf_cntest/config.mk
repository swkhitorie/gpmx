...
PROJ_CDEFS += _USE_LONG_LONG_FORMAT_SPECIFIER=1

# PROJ_CDEFS += RELEASE_BUILD
# PROJ_CDEFS += PX4_LOG_COLORIZED_OUTPUT

PROJ_CINCDIRS += apps/px4_test/perf_cntest/
CPPSOURCES += apps/px4_test/perf_cntest/perf_test.cpp
