...
PROJ_CDEFS += RELEASE_BUILD
# PROJ_CDEFS += PX4_LOG_COLORIZED_OUTPUT

PROJ_CINCDIRS += apps/px4_test/workqueue_test/
CPPSOURCES += apps/px4_test/workqueue_test/ScheduledWorkItemDemo.cpp
CPPSOURCES += apps/px4_test/workqueue_test/workitem_test.cpp
