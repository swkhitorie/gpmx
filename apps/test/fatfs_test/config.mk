...
PROJ_CDEFS += CONFIG_FRCLI_EXCMD_NUM=2

PROJ_CDEFS += CONFIG_BOARD_MMCSD_ENABLE
PROJ_CDEFS += CONFIG_BOARD_MMCSD_FATFS_SUPPORT
PROJ_CDEFS += CONFIG_BOARD_MMCSD_INFO_CHECK

PROJ_CINCDIRS += apps/test/fatfs_test/
CPPSOURCES += apps/test/fatfs_test/app_main.cpp
CPPSOURCES += apps/test/fatfs_test/app_fatfs_test.cpp

PROJ_CINCDIRS += apps/app_fcli/
CSOURCES += apps/app_fcli/app_cli.c
CSOURCES += apps/app_fcli/cli.c
