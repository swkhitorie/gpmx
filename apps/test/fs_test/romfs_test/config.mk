...
PROJ_NAME  :=  romfs_test
PROJ_TC    :=  gae
APP_PROJ_DIR = apps/test/fs_test/romfs_test
...
PROJ_CDEFS += APP_LOAD_ADDRESS=0x08000000
...
PROJ_CDEFS += CONFIG_BOARD_EMBEDPRINTF
PROJ_CDEFS += CONFIG_BOARD_CMBACKTRACE
PROJ_CDEFS += CONFIG_BOARD_PRINTF_SOURCE=2

PROJ_CDEFS += BOARD_USB_CDC1_RX_BUFFER_LEN=8192
PROJ_CDEFS += BOARD_USB_CDC1_TX_BUFFER_LEN=8192
...
CSOURCES += ${APP_PROJ_DIR}/romfs_gromfs.c
