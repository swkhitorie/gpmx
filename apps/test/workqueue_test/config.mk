...
PROJ_CINCDIRS += apps/test/workqueue_test/
CPPSOURCES += apps/test/workqueue_test/ScheduledWorkItemDemo.cpp
CPPSOURCES += apps/test/workqueue_test/workitem_test.cpp
