...
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY	8     /* Interrupt Max Priority can be managed */
...
#define configMINIMAL_STACK_SIZE				((unsigned short)128)   /* Idle Task Stack Size, unit in word */
...
#define configTIMER_TASK_STACK_DEPTH	        (configMINIMAL_STACK_SIZE)      /* Soft Timer Task Stack depth, unit in word */
