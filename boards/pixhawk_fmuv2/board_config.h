...
#define BOARD_INITPIN(port, pin, mode, pull, speed) low_init_pin(port, pin, mode, pull, speed)
...
#define STM32_PLL1P_FREQUENCY   168000000UL
...
extern struct spi_dev_s    *g_ramtron_dev;
