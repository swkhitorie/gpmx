...
#define W25QXX_PAGESIZE                256      // 256byte
#define W25QXX_SECTORSIZE              4096     // 1 sector -> 16 page
#define W25QXX_BLOCKSIZE               65536    // 1 block -> 16 sector
...
#define W25Q16_FLASHID                 0xEF4015
#define W25Q64_FLASHID                 0xEF4017
#define W25Q128_FLASHID                0xEF4018
...
enum w25qxx_cmd {
    ...
    W25QXX_CMD_WRITESTATUS_REG1 = 0x01,
    W25QXX_CMD_WRITE_DISABLE = 0x04,
    W25QXX_CMD_READ_DATA = 0x03,
    W25QXX_CMD_FASTREAD = 0x0B,
    W25QXX_CMD_FASTREAD_DUALOUTPUT = 0x3B,
    W25QXX_CMD_PAGEPROGRAM = 0x02,
    W25QXX_CMD_SECTORERASE = 0x20,
    W25QXX_CMD_POWERDOWN = 0xB9,
    W25QXX_CMD_RELEASE_POWERDOWN_DEVICEID = 0xAB,
