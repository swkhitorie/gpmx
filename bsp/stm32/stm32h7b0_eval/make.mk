...
TMPBOARD_CSRCS = ${addprefix bsp/stm32/stm32h7b0_eval/,${BOARD_CSRCS}}
TMPBOARD_ASMSOURCES = ${addprefix bsp/stm32/stm32h7b0_eval/,${BOARD_ASMSOURCES}}
TMPBOARD_LNK_FILE = ${addprefix bsp/stm32/stm32h7b0_eval/,${BOARD_LNK_FILE}}

BSP_BOARD_ENTRY_POINT   := Reset_Handler
BSP_CDEFS               += ${BOARD_CDEFS}
BSP_CSRCS               += ${TMPBOARD_CSRCS} ${LIB_CSRCS}
BSP_CINCDIRS            += ${LIB_CINCDIRS} bsp/stm32/stm32h7b0_eval
