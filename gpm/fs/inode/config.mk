...
CSOURCES += ${GPMPATH}/fs/inode/fs_inodeaddref.c
CSOURCES += ${GPMPATH}/fs/inode/fs_inodefind.c
CSOURCES += ${GPMPATH}/fs/inode/fs_inodefree.c
CSOURCES += ${GPMPATH}/fs/inode/fs_inodegetpath.c
CSOURCES += ${GPMPATH}/fs/inode/fs_inoderelease.c
