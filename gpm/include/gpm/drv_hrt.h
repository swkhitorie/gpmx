...
#if !defined(CONFIG_MODULE_KPOSIX_QUEUE)
#error drv_hrt need posix queue module
#endif
 ...
 */
__attribute__ ((visibility ("default"))) extern hrt_abstime hrt_elapsed_time_atomic(const volatile hrt_abstime *then);
 ...
 */
__attribute__ ((visibility ("default"))) extern void hrt_store_absolute_time(volatile hrt_abstime *time);
