...
static inline int binaryexpression(struct nsh_vtbl_s *vtbl, char **argv)
{
    char *endptr;
    long integer1;
    long integer2;
...
static inline int unaryexpression(struct nsh_vtbl_s *vtbl, char **argv)
{
    struct stat buf;
    char *fullpath;
    int   ret;
...
static int expression(struct nsh_vtbl_s *vtbl, int argc, char **argv)
{
    int value;
    int i = 0;
