...
#define kinterrupt_enter()
#define kinterrupt_leave()
#elif defined(CONFIG_RTTNANO_ENABLE)
...
#define kinterrupt_enter()                  rt_interrupt_enter()
#define kinterrupt_leave()                  rt_interrupt_leave()
#elif defined(CONFIG_POSIXRUN_ENABLE)
#include "drv_posix_sched.h"
#else
