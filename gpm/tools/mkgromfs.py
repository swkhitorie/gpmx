...
def get_c_data(tree):
    ...
    root_dirent_fmt = '''/* Generated by mkgromfs. Edit with caution. */
#include <gromfs.h>
...
# cmd example
# python .\tools\mkgromfs.py --dump .\libs\fs\romfs\romfs_test\test_file\ .\libs\fs\romfs\romfs_test\romfs_test_data.c
