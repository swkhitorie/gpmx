#ifndef MMCSD_SPI_DRIVER_H_
#define MMCSD_SPI_DRIVER_H_

#include <stdint.h>
#include <device/spi.h>

#ifdef CONFIG_GPDRIVE_MMCSDSPI
...
typedef enum {
	RT_R1 = 1U, /* R1b also handled by mmcsd_receive_R1 */
...
typedef struct {
	...
	uint32_t blockcount; /* MMCSD memory capacity in blocks */
	...
	uint64_t capacity; /* MMCSD memory capacity in bytes */
...
#endif // end with macro CONFIG_GPDRIVE_MMCSDSPI
