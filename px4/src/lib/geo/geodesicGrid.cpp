...
const struct GeodesicGrid::neighbor_umbrella
GeodesicGrid::_neighbor_umbrellas[3]{
...
/* This was generated with
 * libraries/AP_Math/tools/geodesic_grid/geodesic_grid.py */
const float _inverses_init_matrix_1[3*3] = {-0.309017f,  0.500000f,  0.190983f, 0.000000f,  0.000000f, -0.618034f, -0.309017f, -0.500000f,  0.190983f};
const float _inverses_init_matrix_2[3*3] = {-0.190983f,  0.309017f, -0.500000f, -0.500000f, -0.190983f,  0.309017f, 0.309017f, -0.500000f, -0.190983f};     
const float _inverses_init_matrix_3[3*3] = {-0.618034f,  0.000000f,  0.000000f, 0.190983f, -0.309017f, -0.500000f, 0.190983f, -0.309017f,  0.500000f};  
const float _inverses_init_matrix_4[3*3] = {-0.500000f,  0.190983f, -0.309017f, 0.000000f, -0.618034f,  0.000000f, 0.500000f,  0.190983f, -0.309017f};  
const float _inverses_init_matrix_5[3*3] = {-0.190983f, -0.309017f, -0.500000f, -0.190983f, -0.309017f,  0.500000f, 0.618034f,  0.000000f,  0.000000f};
const float _inverses_init_matrix_6[3*3] = {-0.309017f, -0.500000f, -0.190983f, 0.190983f,  0.309017f, -0.500000f, 0.500000f, -0.190983f,  0.309017f};
const float _inverses_init_matrix_7[3*3] = {0.309017f, -0.500000f,  0.190983f, 0.000000f,  0.000000f, -0.618034f, 0.309017f,  0.500000f,  0.190983f};
const float _inverses_init_matrix_8[3*3] = {0.190983f, -0.309017f, -0.500000f, 0.500000f,  0.190983f,  0.309017f, -0.309017f,  0.500000f, -0.190983f};
const float _inverses_init_matrix_9[3*3] = {0.500000f, -0.190983f, -0.309017f, 0.000000f,  0.618034f,  0.000000f, -0.500000f, -0.190983f, -0.309017f};
const float _inverses_init_matrix_10[3*3] = {0.309017f,  0.500000f, -0.190983f, -0.500000f,  0.190983f,  0.309017f, -0.190983f, -0.309017f, -0.500000f};
const matrix::Matrix3f GeodesicGrid::_inverses[10]{
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_1)},
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_2)},
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_3)},
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_4)}, 
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_5)},     
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_6)},  
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_7)},
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_8)},
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_9)},
    {static_cast<matrix::Matrix3f>(_inverses_init_matrix_10)},
};

/* This was generated with
 * libraries/AP_Math/tools/geodesic_grid/geodesic_grid.py */
const float _mid_inverses_init_matrix_1[3*3] = {-0.000000f,  1.000000f, -0.618034f, 0.000000f, -1.000000f, -0.618034f, -0.618034f,  0.000000f,  1.000000f};
const float _mid_inverses_init_matrix_2[3*3] = {-1.000000f,  0.618034f, -0.000000f, -0.000000f, -1.000000f,  0.618034f, 0.618034f, -0.000000f, -1.000000f};     
const float _mid_inverses_init_matrix_3[3*3] = {-0.618034f, -0.000000f, -1.000000f, 1.000000f, -0.618034f, -0.000000f, -0.618034f,  0.000000f,  1.000000f}; 
const float _mid_inverses_init_matrix_4[3*3] = {-1.000000f, -0.618034f, -0.000000f, 1.000000f, -0.618034f,  0.000000f, -0.000000f,  1.000000f, -0.618034f};  
const float _mid_inverses_init_matrix_5[3*3] = {-1.000000f, -0.618034f,  0.000000f, 0.618034f,  0.000000f,  1.000000f, 0.618034f,  0.000000f, -1.000000f};
const float _mid_inverses_init_matrix_6[3*3] = {-0.618034f, -0.000000f, -1.000000f, 1.000000f,  0.618034f, -0.000000f, 0.000000f, -1.000000f,  0.618034f};
const float _mid_inverses_init_matrix_7[3*3] = {0.000000f, -1.000000f, -0.618034f, 0.000000f,  1.000000f, -0.618034f, 0.618034f, -0.000000f,  1.000000f};
const float _mid_inverses_init_matrix_8[3*3] = {1.000000f, -0.618034f, -0.000000f, 0.000000f,  1.000000f,  0.618034f, -0.618034f,  0.000000f, -1.000000f};
const float _mid_inverses_init_matrix_9[3*3] = {1.000000f,  0.618034f, -0.000000f, -1.000000f,  0.618034f,  0.000000f, 0.000000f, -1.000000f, -0.618034f};
const float _mid_inverses_init_matrix_10[3*3] = {-0.000000f,  1.000000f,  0.618034f, -1.000000f, -0.618034f, -0.000000f, 0.618034f,  0.000000f, -1.000000f};
const matrix::Matrix3f GeodesicGrid::_mid_inverses[10]{
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_1)},
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_2)},
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_3)},
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_4)}, 
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_5)},     
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_6)},  
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_7)},
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_8)},
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_9)},
    {static_cast<matrix::Matrix3f>(_mid_inverses_init_matrix_10)},
};

int GeodesicGrid::section(const matrix::Vector3f &v, bool inclusive)
{
...
int GeodesicGrid::_neighbor_umbrella_component(int idx, int comp_idx)
{
    if (idx < 3) {
...
int GeodesicGrid::_from_neighbor_umbrella(int idx,
                                             const matrix::Vector3f &v,
                                             const matrix::Vector3f &u,
                                             bool inclusive)
{
    ...
    if (matrix::isEqualF(u(0), u(1))) {
        ...
        matrix::Vector3f w = _inverses[comp % 10] * v;
        if (comp > 9) {
            w = -w;
        }
        ...
        if (math::isZero(x0)) {
            ...
            return _neighbor_umbrella_component(idx, u(0) < u(1) ? 3 : 2);
        }
...
int GeodesicGrid::_triangle_index(const matrix::Vector3f &v, bool inclusive)
{
    /* w holds the coordinates of v with respect to the basis comprised by the
     * vectors of T_i */
    matrix::Vector3f w = _inverses[0] * v;
    int zero_count = 0;
    int balance = 0;
    int umbrella = -1;
    ...
    case 1:
        ...
        if (!math::isZero(w(0)) && w(0) < 0) {
            umbrella = 1;
        } else if (!math::isZero(w(1)) && w(1) < 0) {
            umbrella = 2;
        } else {
            umbrella = 0;
        }
...
int GeodesicGrid::_subtriangle_index(const unsigned int triangle_index,
                                        const matrix::Vector3f &v,
                                        bool inclusive)
{
    /* w holds the coordinates of v with respect to the basis comprised by the
     * vectors of the middle triangle of T_i where i is triangle_index */
    matrix::Vector3f w = _mid_inverses[triangle_index % 10] * v;
    if (triangle_index > 9) {
        w = -w;
    }

    if ((math::isZero(w(0)) || math::isZero(w(1)) || math::isZero(w(2))) && !inclusive) {
        return -1;
    }
    ...
    if (!math::isZero(w(1)) && w(1) < 0) {
        return 1;
    }
    if (!math::isZero(w(2)) && w(2) < 0) {
        return 2;
    }
