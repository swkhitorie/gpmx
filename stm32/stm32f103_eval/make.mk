...
TMPBOARD_CSRCS = ${addprefix ${BSP_ROOT}/stm32/stm32f103_eval/,${BOARD_CSRCS}}
TMPBOARD_ASMSOURCES = ${addprefix ${BSP_ROOT}/stm32/stm32f103_eval/,${BOARD_ASMSOURCES}}
TMPBOARD_LNK_FILE = ${addprefix ${BSP_ROOT}/stm32/stm32f103_eval/,${BOARD_LNK_FILE}}
...
BSP_CINCDIRS += ${BSP_ROOT}/stm32/stm32f103_eval ${LIB_CINCDIRS}
