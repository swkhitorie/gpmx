...
TMPBOARD_CSRCS = ${addprefix ${BSP_ROOT}/stm32/stm32f427_fmuv2/,${BOARD_CSRCS}}
TMPBOARD_ASMSOURCES = ${addprefix ${BSP_ROOT}/stm32/stm32f427_fmuv2/,${BOARD_ASMSOURCES}}
TMPBOARD_LNK_FILE = ${addprefix ${BSP_ROOT}/stm32/stm32f427_fmuv2/,${BOARD_LNK_FILE}}
...
BSP_CINCDIRS += ${BSP_ROOT}/stm32/stm32f427_fmuv2 ${LIB_CINCDIRS}
